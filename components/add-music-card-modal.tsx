...
interface AddMusicCardModalProps {
  isOpen: boolean
  onClose: () => void
  onSave: (data: { artist: string; song: string; image: string }) => void
}

export default function AddMusicCardModal({
  isOpen,
  onClose,
  onSave,
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-[425px] bg-gray-800 text-white">
        <DialogHeader>
          <DialogTitle>Add New Music Card</DialogTitle>
          <DialogDescription>Enter details for the new music card. Click save when you're done.</DialogDescription>
        </DialogHeader>
